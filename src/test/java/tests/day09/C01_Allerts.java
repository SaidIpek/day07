...
// Sag click yapamiyorsak alert bir JS Allert'dur ve switchTo() kullanilarak handle edilebilir
    ...
    public void acceptAlert() {
     ...
     WebElement resultElementi = driver.findElement(By.id("result"));

     String expectedResult="You successfully clicked an alert";
     String actualResult=resultElementi.getText();

     assertEquals(actualResult,expectedResult,"sonuc yazisi istenen ile aynı degil.");
...
public void dismissAlert(){
        ...
        assertFalse(actualResult.contains(istenmeyenKelime),"result yazısı istenmeyen kelimeyi içeriyor.");
    ...
    public void sendKeysAlert(){
        ...
        softAssert.assertTrue(actualResult.contains("said"));
