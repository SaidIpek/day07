...
public class C04_SoftAssert {
    ...
    public void test() {
        ...
        softAssert.assertTrue(driver.getTitle().contains("Türkiye'nin En Büyük Online Alışveriş Sitesi Hepsiburada.com"), "title istenen cumleyi icermiyor.");
        ...
        softAssert.assertTrue(sonucYazisiElementi.getText().contains("araba"), "Sonuc yazısı araba kelimesini icermiyor");

        softAssert.assertFalse(sonucYazisiElementi.getText().contains("oto"), "sonuc yazısı oto kelimesini iceriyor.");
