...
//TEstleri birbirine bagladıgımızda
    ...
    //eger 3 test veya daha fazlasi birbirine dependson ile baglandysa
    ...
    public void test3(){
        ...
        Assert.assertEquals(fiyat.getText(),"$16.83","Nutella istenen fiyatta degil.");
