...
public class C02_DropDown {
    ...
    public void test() throws InterruptedException {
        ...
        //2. adim Select class'ini kullanarak bir obje olusturduk
        //ve parametre olarak locate ettigimiz WebElement'i yazdık.
        Select select = new Select(dropDown);
        //3.adim istedigin option'i Select objesi kullanarak sec.
